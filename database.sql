...
(7, 4, 'subject', '資料結構與演算法', '熟悉常見資料結構（如陣列、鏈結串列、樹）並能應用排序和搜尋演算法。', 'rejected', '', 1, '2025-12-02 03:42:26', '2025-11-17 17:08:47', '2025-12-02 03:42:26'),
(8, 4, 'language', 'Java', '具備物件導向程式設計（OOP）概念，能使用 Java 進行應用程式開發。', 'pending', NULL, NULL, NULL, '2025-11-17 17:08:47', '2025-11-17 17:08:47'),
(9, 4, 'competition', '資訊奧林匹亞競賽', '參加全國資訊奧林匹亞競賽，學習演算法解題。', 'approved', '', 1, '2025-12-02 03:25:41', '2025-11-17 17:08:47', '2025-12-02 03:25:41'),
(10, 4, 'certificate', 'LPI Linux Essentials', '通過 LPI Linux Essentials 認證考試，掌握基本的 Linux 操作和指令。', 'approved', '', 1, '2025-12-02 03:43:43', '2025-11-17 17:08:47', '2025-12-02 03:43:43'),
...
(14, 2, 'subject', '網頁設計', '能夠用 HTML、CSS、JavaScript 建立響應式網頁', 'approved', NULL, NULL, NULL, '2025-11-17 17:25:54', '2025-11-18 06:16:25'),
...
(4, 'zdx_1013', '123456', 'cvu31161a@gmail.com', '鄭得諼', 'student', 'user_4_1763398311.png', '喜歡運動、玩手遊', '2025-11-17 16:49:07');
